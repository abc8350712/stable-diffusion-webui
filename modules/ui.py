        ...
        with gr.Column(elem_id=f"{id_part}_prompt_container", scale=6):
            with gr.Row():
                with gr.Column(scale=80):
                    with gr.Row():
                        prompt = gr.Textbox(value="cinema light,  bright colors,  super high resolution, original, extremely delicate and beautiful,  face blush,  eddish-pink, beautiful detailed eyes and face,  beautiful detailed eyelash, 1girl, (blurry background:1.4),  solo,(masterpiece:1.4),(best quality:1.4) <lora:fashion:0.2>", label="Prompt", elem_id=f"{id_part}_prompt", show_label=False, lines=3, placeholder="Prompt (press Ctrl+Enter or Alt+Enter to generate)")
